...
- **Rect Room (R):** click-drag to generate a 4-wall rectangular loop with shared vertices.
...
- Use **Select** for click-only selection and **Move (G)** for dragging vertices/edges/openings.
